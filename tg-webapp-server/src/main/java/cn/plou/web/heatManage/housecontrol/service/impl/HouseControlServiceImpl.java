...
public class HouseControlServiceImpl implements HouseControlService {
	...
	public String houseControl(Map<String, Object> maps) {
		try {
			...
			if(type == null || valveControl== null){
				return "缺少必要参数";
			}
...
//			}
	...
	public Root controlInfoList(Map<String, Object> map) {
		...
		List<HouseControlInfoDO> runningDataTotalList = houseControlDao.controlInfoList(map);
	...
	public Root operControlInfo(Map<String, Object> params) {
		Root root = new Root();
		String strvalveControl = getMapValue(params, "valveControl");
		if (strvalveControl != null) {
		...
		String meterControl = getMapValue(params, "meterControl");
	...
	public Root operDevInfo(Map<String, Object> params) {
		...
		Root root = new Root();
		String strvalveControl = getMapValue(params, "devControl");
		if (strvalveControl != null) {
			String strdes = houseControl(params);
			if (!strdes.isEmpty()) {
				root.setCode(1);
