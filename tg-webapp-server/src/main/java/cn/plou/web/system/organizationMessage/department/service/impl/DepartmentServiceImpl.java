...
public class DepartmentServiceImpl implements DepartmentService {
    ...
    public int addDepartment(Department department) {
        ...
        department.setCreateUser(UserUtils.getUserId());
    ...
    public int modifyDepartmentBatch(DepartmentVo departmentVo) {
        ...
        userPageHistoryServiceImpl.addUserPageHistory(userPageHistory);
        departmentVo.setUpdateUser(UserUtils.getUserId());
        departmentVo.setUpdateDate(new Date());
    ...
    public int modifyDepartment(Department department) {
        ...
        userPageHistoryServiceImpl.addUserPageHistory(userPageHistory);
        department.setUpdateUser(UserUtils.getUserId());
