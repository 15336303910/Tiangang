...
public class MapLineSelelctInfo {
    private MapLineVo searchCondition;
    ...
    public MapLineVo getSearchCondition() {
        return searchCondition;
    }

    public void setSearchCondition(MapLineVo searchCondition) {
