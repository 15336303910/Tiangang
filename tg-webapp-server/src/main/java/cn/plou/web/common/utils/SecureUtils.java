...
public class SecureUtils {
    ...
    public static String AESEncode(String encodeRules,String content){
        try {
            ...
            //不再使用new SecureRandom(encodeRules.getBytes())，防止linux下生成随机key
            ...
            e.printStackTrace();
            throw new RuntimeException("错误！加密和解密服务器环境不一致！加密失败！");
        }
    ...
    public static String AESDncode(String encodeRules,String content){
        try {
            ...
            e.printStackTrace();
            throw new RuntimeException("错误！加密和解密服务器环境不一致！解密失败！");
        }
    }
}
