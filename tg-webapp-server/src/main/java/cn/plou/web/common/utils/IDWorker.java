 ...
 * @File :IDWorker.java
 * @Author : WangJiwei
 * @Date :2017年11月15日上午10:48:27
 *
 * @Comments : 唯一ID生成
 */
public class IDWorker {

    private static final Sequence SEQ = getSeq();

    public static String getId() {
	return String.valueOf(SEQ.nextId());
    }
    ...
    private static Sequence getSeq() {
     ...
     * @File :Sequence.java
     * @Author : WangJiwei
     * @Date :2017年10月15日下午14:39:00
     *
     * @Comments : CopyRight : http://git.oschina.net/yu120/sequence
     * 
     */
	...
	private static final int OFFSET_ = 5;
