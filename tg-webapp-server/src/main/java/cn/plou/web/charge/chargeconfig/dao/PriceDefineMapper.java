...
public interface PriceDefineMapper {
    ...
    List<PriceDefine> selectByAnnualAndCommunityIds(@Param("annual")String annual,@Param("commuityIds")List<String> commuityIds);

    List<PriceDefine> selectByAnnualAndStationIds(@Param("annual")String annual,@Param("stationIds")List<String> stationIds);

    List<PriceDefine> selectByAnnualAndConsumerIds(@Param("annual")String annual,@Param("consumerIds")List<String> consumerIds);
    ...
    PriceDefine findBypriceNameAndcompanyId(@Param("priceName")String priceName,@Param("companyId")String companyId);
}
