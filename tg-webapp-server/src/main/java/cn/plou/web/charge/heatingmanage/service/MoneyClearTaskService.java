...
public interface MoneyClearTaskService {
     ...
     * @return 分页信息
     */
    PageInfo<MoneyClearTask> getMoneyClearTaskList(String beginCreateDate,String  endCreateDate, List<String>   consumerIdList,MoneyClearTask  moneyClearTask, BasePageEntity  basePageEntity);
    ...
    List<TaskNumResult> getTaskNum(String beginCreateDate, String  endCreateDate, List<String>   consumerIdList, MoneyClearTask moneyClearTask);
