...
public interface MbusService {
    ...
    List<String> getAllMbusCodesByConsumerIds(String consumer);
    ...
    String exportExcel(ServletRequest request,MbusSelectInfo mbusSelectInfo);
	  ...
	  List<String> getMbusIdsByRoleId();
		void modifyMbusAddressbyConsumer(String commuityId, String changedAdress, String orgAddress);
		void modifyMbusAddress(String consumerId, String address);
		List<MbusInfo> getMbusControls(List<String> mbusCodes,String consumerId,String mbusControl,String mbusControlParam);
}
