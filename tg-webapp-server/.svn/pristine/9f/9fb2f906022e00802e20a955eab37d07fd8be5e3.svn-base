...
public interface UserYearHeatService {
    ...
    PageInfo<HeatInfoVO>  getHeatInfoList(String companyId,String heatPriceType,String chargeType,String heatUserType,String heatingStatus,String floorHigh, String order, String sortby, Integer page, Integer pageSize);
